...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans("pages.Posts")}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans("pages.edit post")}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="bg-gray-200 p-4">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <label for="">{{trans("pages.current categories")}}</label>
                                                        <div class="form-control">{{ $post->categories[0]['name'] }}</div>
                                                    </div>
                                                    <br>
                                                    <div class="main-content-label mg-b-5">
                                                ...
                                                <div class="form-group">
                                                    <div>
                                                        <label for="">{{trans("pages.current tags")}}</label>
                                                        <div class="form-control">{{$post->tags[0]['name']}}</div>
                                                    </div>
                                                    <br>
                                                    <div class="main-content-label mg-b-5">
                                                        {{trans("pages.tags")}}
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <img src="/images/{{$post->image}}" alt="cfvfds" width="100px" height="100px"><br>
                                                    </div>
                                                    <br>
                                                ...
                                                <div class="row row-xs wd-xl-80p">
                                                    <div class="col-sm-6 col-md-3">
                                                        <button class="btn btn-primary-gradient btn-block">{{trans("pages.edit")}}</button>
                                                    </div>
                                                </div>
